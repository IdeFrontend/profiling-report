...
Spec style lives in nested files (loaded when editing those trees): `specs/AGENTS.md`, `src/ui/AGENTS.md`. Cursor-only auto-post-after-review lives in `.cursor/rules/code-review-post-github.mdc`.
