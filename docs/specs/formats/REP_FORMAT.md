...
Normative description of the binary report container used by profiling-report. Derived from [`data/pack_rep.py`](../../../data/pack_rep.py) and [`data/unpack_rep.py`](../../../data/unpack_rep.py).
...
Both use the same binary layout and magic. Hosts should open either extension with the profiling-report viewer.
