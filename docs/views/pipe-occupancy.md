...
|---------------|-------|-----------------|--------|
| `pipeOccupancy` | `PipeUtilizationHist.csv` (prefer) or `PipesUtilization.csv` | Keep emulate basenames — **do not** invent `PipeUtilization.csv` ([DATA-40](../context/decisions/DATA.md)) | `adapt-mapper` |
