...
|---------------|-------|-----------------|--------|
| `SwimlaneModel` | `PipeTrace.json` (µs) | Producer converts ticks → µs ([DATA-41](../context/decisions/DATA.md)) | `same-path` |
...
- Product docx §: 11.2.8
- Decisions: [DATA-41](../context/decisions/DATA.md), [PROC-3](../context/decisions/PROC.md), [PROC-8](../context/decisions/PROC.md)
