...
- Click unpinned pushpin → parent appends lane id to **pinnedLaneIds**; click pinned → remove. Context-menu **Pin row** (Alt+P while the menu is open) toggles the same **pinnedLaneIds** — one pin state, two affordances.
