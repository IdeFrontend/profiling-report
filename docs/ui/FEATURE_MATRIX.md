...
| PIPE occupancy bars | M | From PipeUtilization.csv; default mean non-`NA` ([DATA-28](../context/decisions/DATA.md)); All \| block switcher when >1 block (PR-STATS-014b); **hide** if missing |
...
| Memory detail tabs + block + 查看全部 | M1 | Memory L1 / L2Cache / Memory L0 / Memory UB; block switcher [DATA-19](../context/decisions/DATA.md) / [DATA-29](../context/decisions/DATA.md); 查看全部 [DATA-33d](../context/decisions/interim/DATA.md) (#4); searchable field lists (filter + highlight) |
