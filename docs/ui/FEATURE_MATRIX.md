...
| Emulate Sept 30 (M4): Timeline + thin summary + PIPE + Architecture Diagram + CANNBot | M | [milestone-4](../process/roadmap/milestone-4.md); ArchDiagramMetrics → `archDiagram` ([arch-diagram](../views/arch-diagram.md)); heatmap / roofline / overview **out** — [emulate/FORMAT](../formats/emulate/FORMAT.md) |
