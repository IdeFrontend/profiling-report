...
| Emulate Sept 30: Timeline + thin summary + PIPE when packed | M | `manifest.json` + optional PipeTrace + KernelInfo/summary + PipesUtilization — [emulate/FORMAT](../formats/emulate/FORMAT.md); view packets [views/](../views/); gaps: [roofline](../views/roofline.md) / [memory-topology](../views/memory-topology.md) / [overview-charts](../views/overview-charts.md) |
