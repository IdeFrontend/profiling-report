...
<<<<<<< HEAD
| Compute-load detail tabs | M1 | `PipeUtilization` \| `ArithmeticUtilization` \| `ResourceConflictRatio` (#3); searchable field lists (filter + highlight, [UI-43](../context/decisions/UI.md)) |
...
>>>>>>> 21b63b9d (feat: AIC|AIV0|AIV1 PIPE toggle for emulate occupancy)
