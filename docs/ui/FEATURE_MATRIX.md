...
| Emulate Sept 30 (M4): Timeline + thin summary + PIPE + memory topology + CANNBot | M | [milestone-4](../process/roadmap/milestone-4.md); `manifest.json` + PipeTrace + KernelInfo/summary + PipesUtilization + ArchDiagramMetrics — [emulate/FORMAT](../formats/emulate/FORMAT.md); view packets [views/](../views/); gaps: [roofline](../views/roofline.md) / [overview-charts](../views/overview-charts.md) |
