...
**Default locale:** `zh-CN` (interim [PKG-2](../context/OPEN_QUESTIONS.md) / [PACKAGING_SUGGESTIONS](../context/PACKAGING_SUGGESTIONS.md)). Product has not closed PKG-2; do not treat English as the product default until then.
