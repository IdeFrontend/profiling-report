...
- **Pin lane (P2):** leaf-row pushpin in gutter (`source/v930/hardware-more-detail.jpeg`); pinned duplicates in sticky strip at top — see [`INTERACTIONS.md`](INTERACTIONS.md)
