...
| **Sketches** | Same Timeline chrome as S1; emulate surfaces per [views catalog](../views/README.md) / [VIEW_DATA_MAPPING emulate TOC](VIEW_DATA_MAPPING.md#emulate-profile) |
