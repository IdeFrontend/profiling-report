...
| **Steps** | Read util bars in gutter; optionally switch Card-header metric (时钟周期 / 缓存命中率 / 任务 / 利用率) to compare alternate views; compare PIPE ranking in aside; expand a core to see child pipes |
