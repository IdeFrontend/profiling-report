...
**Explicit non-goal:** parsing or rendering MindStudio Insight `.bin` inside this library. **Do not** silently remap simulator CSVs into hardware embeds ([DATA-40](../context/decisions/DATA.md)).
