...
Simulator leaf payloads (`manifest.json` + `PipeTrace.json` + KernelInfo/summary) → same `AdaptedReport`. Phase 1: Timeline + thin summary; omit PIPE/memory until mappers exist ([DATA-40](../context/decisions/DATA.md)).
