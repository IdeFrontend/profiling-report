...
| `.npu-rep` | **profiling-report** panel ([PROC-2](../context/decisions/PROC.md)). Hardware or **simulator** leaf — library detects via `SimulatorManifest.json` ([PROC-8](../context/decisions/PROC.md)); host does **not** need a second extension ([PROC-6](../context/decisions/PROC.md)). |
