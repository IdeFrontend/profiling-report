...
| `PipeTrace.json` | json | **Recommended** for timeline. Chrome Trace Event format; **µs** `ts`/`dur` ([DATA-41](../../context/decisions/DATA.md)). **Absence → null swimlane**, leaf still opens |
