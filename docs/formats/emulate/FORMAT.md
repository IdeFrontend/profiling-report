...
Display ↔ field detail: [views catalog](../../views/README.md) (per-packet fills); docx § index: [VIEW_DATA_MAPPING.md](../../ui/VIEW_DATA_MAPPING.md). Hide rules (adapted VM): [VIEW_DATA_REQUIREMENTS.md](../VIEW_DATA_REQUIREMENTS.md).
