...
| Compute (e.g. 172/320 TFLOPS) | `ArithmeticUtilization` (+ peaks TBD) | **Placeholder** until Q6 / data spec — title + `N/A` (do not invent values) — [I-Q6a](../context/INTERIM_DECISIONS.md) |
...
| Avg core util % | PipeUtilization / OpBasicInfo TBD | **Placeholder** until Q6 / data spec — title + `N/A` (do not invent values) — [I-Q6a](../context/INTERIM_DECISIONS.md) |
