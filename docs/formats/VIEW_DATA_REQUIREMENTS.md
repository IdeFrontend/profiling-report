...
**Interim ([DATA-32a](../context/decisions/interim/DATA.md)):** Adapter returns `overviewSeries: []` on current fixtures; charts stay hidden until a producer fills series.
