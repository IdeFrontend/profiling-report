...
Do **not** invent hardware CSVs from simulator tables ([DATA-40](../context/decisions/DATA.md)).
...
| `summary.taskDurationUs` / identity | `KernelInfo.csv` and/or `summary.json` | Best-effort; exact map [DATA-42](../context/questions/DATA.md). Omit cards when unmappable |
