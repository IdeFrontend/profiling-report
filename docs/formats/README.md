...
Related: [../views/](../views/) · [VIEW_DATA_MAPPING.md](../ui/VIEW_DATA_MAPPING.md) (docx/sketch index). Decisions: [PROC-6](../context/decisions/PROC.md) … [PROC-8](../context/decisions/PROC.md), [DATA-40](../context/decisions/DATA.md), [DATA-41](../context/decisions/DATA.md).
