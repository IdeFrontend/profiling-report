...
- [ ] Gaps vs sketches acknowledged — use interim fixture rules ([INTERIM_DECISIONS](../context/INTERIM_DECISIONS.md) DATA-31a); no silent inventing of multi-core data the fixture lacks
