...
The open list is for **unanswered** items only: [OPEN_QUESTIONS.md](../context/OPEN_QUESTIONS.md) (status `open` / `partial` / `interim` / `deferred`). Product-final answers live in [decisions/](../context/decisions/).
