...
Prioritized questions to close gaps and contradictions between [INPUT_FORMATS.md](../formats/README.md), [product-sections.md](../views/product-sections.md), product §11.2 mockups, and the local sample [`data/out.rep`](../../data/out.rep).
