...
Prioritized questions to close gaps and contradictions between [INPUT_FORMATS.md](../formats/README.md), [VIEW_DATA_MAPPING.md](../ui/VIEW_DATA_MAPPING.md), product §11.2 mockups, and the local sample [`data/out.rep`](../../data/out.rep).
