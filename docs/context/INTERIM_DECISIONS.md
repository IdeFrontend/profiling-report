...
| **I-Q14** | Time units | **Time (auto):** s / ms / µs / ns from viewport or axis density. **No** manual unit dropdown. **No** clock-cycle mode yet | Formatter + viewport/overview resolvers | Product specifies cycle mode + frequency source |
