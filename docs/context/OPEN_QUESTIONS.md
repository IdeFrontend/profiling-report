...
| D-PIN-FOLDER | 2026-09-04 | **Deferred** this iteration — do not ship folder/group pin; leaf-only pin stays. Implementation parked on `feat/pin-grouping-nodes` (PR #69 closed unmerged) | [INTERIM_DECISIONS](INTERIM_DECISIONS.md) D-PIN-FOLDER, [FEATURE_MATRIX](../ui/FEATURE_MATRIX.md) |
