...
| Fixture thinner than sketches | Why don’t I see multi-core instruction Gantt? | Target = sketches ([DATA-31](OPEN_QUESTIONS.md)); render available lanes; hide empty charts ([DATA-32](decisions/DATA.md)) | Interim `out.rep` until golden |
