...
This rewrites `data-1.png`–`data-29.png`, `ui-30.png`–`ui-36.png`, `dimensions.json`, and `<img width height>` tags in [`questions/`](../../questions/). GitHub markdown stretches bare `![]()` on wide crops; explicit HTML dimensions plus letterboxing (max 4:1) avoids distortion.
