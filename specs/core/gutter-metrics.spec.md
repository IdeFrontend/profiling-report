...
Source file: embedded **`PipeUtilization.csv`** inside `.rep` / `.ncrep` ([METRICS_AND_TRACE.md](../../docs/formats/compute/METRICS_AND_TRACE.md) § PipeUtilization.csv). Decision: [DATA-38](../../docs/context/decisions/DATA.md).
