...
- **2026-09-03** — Summary bars become interactive: hover lift, hit-testable, dimmed `SUMMARY_LABEL_COLOR` "N tasks" label (normal font); PR-RENDER-025 / PR-RENDER-026.
- **2026-09-03** — Collapsed-group summary events: gray `LaidOutEvent`s on folder lanes; `paintGroupBands`/ProfilerStep bands removed. PR-RENDER-025.
