...
1. **PR-RENDER-026**: Summary bars render an italic "N tasks" label (`taskCountLabel`) and lift to the OKLCH hover fill under the pointer; they are never dimmed by search/selection and never selected/ringed.
...
- **2026-09-03** — Summary bars become interactive: italic "N tasks" label, hover lift, hit-testable; PR-RENDER-025 / PR-RENDER-026.
