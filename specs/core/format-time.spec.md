...
**Two-tier auto scale** ([UI-40a](../../docs/context/INTERIM_DECISIONS.md)). Wall-time labels use `TimeScaleUnit` (`s` / `ms` / `us` / `ns`).
...
UI-40a — Time (auto scale); see [INTERIM_DECISIONS UI-40a](../../docs/context/INTERIM_DECISIONS.md).
