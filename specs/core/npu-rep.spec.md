...
12. **PR-NPU-012** — A leaf whose payloads include `SimulatorManifest.json` with `profile: "simulator"` is classified as simulator and MUST NOT require hardware `OpBasicInfo.csv` / `PipeUtilization.csv` to load ([PROC-8](../../docs/context/decisions/PROC.md), [DATA-45](../../docs/context/decisions/DATA.md)).
...
## Changelog
- **2026-09-14** — PR-NPU-012: simulator leaf detection via `SimulatorManifest.json`; no hardware CSV requirement ([PROC-8](../../docs/context/decisions/PROC.md), [DATA-45](../../docs/context/decisions/DATA.md)).
