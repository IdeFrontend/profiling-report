...
12. **PR-NPU-012** — A leaf whose payloads include emulate `manifest.json` (thin profile or export catalog) is classified as emulate and MUST NOT require compute `OpBasicInfo.csv` / `PipeUtilization.csv` to load ([PROC-8](../../docs/context/decisions/PROC.md), [DATA-40](../../docs/context/decisions/DATA.md)).
...
## Changelog
- **2026-09-14** — PR-NPU-012: simulator leaf detection via `manifest.json`; no hardware CSV requirement ([PROC-8](../../docs/context/decisions/PROC.md), [DATA-40](../../docs/context/decisions/DATA.md)).
