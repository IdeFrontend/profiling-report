...
**PipeTrace time unit.** Product / emulate `PipeTrace.json` timestamps are **µs** at the viewer ([DATA-46](../../docs/context/decisions/DATA.md) for emulate packer conversion).
