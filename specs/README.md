...
| [input-formats](./core/input-formats.spec.md) | `PR-FMT-*` | MVP | `docs/formats/README.md` (formats hub) | `tests/unit/parseRep.spec.ts` |
...
| SummaryCategoryList | `PR-SUMM-*` | M1 | `src/ui/StatsAside/SummaryCategoryList/SummaryCategoryList.spec.md` |
...
| ContextMenu | `PR-CTXMENU-*` | MVP subset | `src/ui/ContextMenu/ContextMenu.spec.md` |
