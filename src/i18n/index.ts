...
const messages = {
  'zh-CN': {
    ...
    userGuide: '用户指南',
    mouseControl: '鼠标操作',
    keyboardControl: '键盘操作',
    combinedControl: '组合操作',
    verticalMovement: '纵向移动',
    singleBoxSelection: '单击 / 框选',
    panLeft: '左移',
    panRight: '右移',
    scaling: '缩放',
    dragPan: '平移',
    ...
    multiSelectSlices: 'Slices ({n})',
    multiSelectClose: 'Close',
    multiSelectName: 'Name',
    multiSelectWallDuration: 'Wall Duration',
    multiSelectSelfTime: 'Self time',
    multiSelectAvgWallDuration: 'Average Wall Duration',
    multiSelectEmpty: 'No items selected',
  },
  en: {
    ...
    combinedControl: 'Combined control',
    verticalMovement: 'Vertical movement',
    singleBoxSelection: 'Single / box select',
    panLeft: 'Move left',
    panRight: 'Move right',
    scaling: 'Scaling',
    dragPan: 'Pan',
