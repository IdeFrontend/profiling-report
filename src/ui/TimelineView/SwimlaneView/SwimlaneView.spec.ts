...
describe('SwimlaneView', () => {
  ...
  it('PR-SWIMVIEW-030: parent-driven multiSelectedIds change reaches the canvas (marquee commit)', async () => {
  ...
  it('PR-SWIMVIEW-027: pinned strip height accounts for multi-row leaf', () => {
  ...
  it('PR-SWIMVIEW-031: scroll-y syncs gutter and card-strip transform in the same turn', async () => {
    ...
    expect(
      (wrapper.get('.pr-card-strips__scroll').element as HTMLElement).style.transform,
