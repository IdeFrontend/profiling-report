...
65. **PR-CANVAS-065** — Clicking a collapsed-group summary bar emits `toggle-group` with the folder id, clears hover (`hover` null so the summary tooltip dismisses), and does **not** emit `select` (in both default and measure modes).
