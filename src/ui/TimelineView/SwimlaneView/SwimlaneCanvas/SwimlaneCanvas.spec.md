...
- **2026-09-10** — Right-click (`e.button !== 0`) no longer runs the left-click pointer path (`PR-CANVAS-075`); `contextmenu` resolves a leaf lane id via `leafLaneIdAtPoint` (`PR-CANVAS-076`), with the collapsed-folder summary-bar exception in `PR-CANVAS-077`.
