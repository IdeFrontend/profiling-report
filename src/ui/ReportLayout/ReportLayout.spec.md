...
| Narrow layout | Timeline shrinks to fit; aside stays right (`minmax(0, 1fr)` main track) |
...
6. **PR-LAYOUT-006** — Keeps two-column grid when aside is visible (`minmax(0, 1fr)` main track; no viewport stack).
