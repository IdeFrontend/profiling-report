...
## Changelog
- **2026-09-07** — Optional `userGuideUrl` (default demo guide) forwarded to toolbar help button; product host files are `.npu-rep` ([PROC-2](../../docs/context/decisions/PROC.md)).
