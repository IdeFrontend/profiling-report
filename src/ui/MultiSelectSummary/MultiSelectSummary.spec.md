...
10. **PR-MSEL-010** — `dimmed` keeps the stale table mounted (dimmed, non-interactive) instead of unmounting it.

## Changelog

- **2026-09-23** — `dimmed` keeps the stale table mounted (dimmed, non-interactive) while the marquee is still growing; the table recalculates on settle/commit (`PR-MSEL-010`).
