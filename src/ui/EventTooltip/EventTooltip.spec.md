...
2. **PR-TOOLTIP-002** — Formats start time, duration, and end time (duration: 4 significant digits; start/end: `nsPerPx` digits when provided; uniform digit chrome, unit via text).
