...
3b. **PR-STATS-036** — Emulate Cube|Vector 0|Vector 1 toggle when ≥2 core sides present; filters bars by core; does not appear for blank `opType` with only `cube`/`vector` sides ([UI-54](../../../docs/context/decisions/UI.md)).
