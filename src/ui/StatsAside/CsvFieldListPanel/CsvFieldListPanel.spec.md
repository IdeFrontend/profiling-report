...
Reusable searchable CSV field list with tabs, optional block switcher, and 查看全部 (DATA-19 / DATA-29 / DATA-33d; sketches `v930/compute-load-detail`, `v930/search-highlight`, `v930/memory-load-detail`).
...
9. **PR-CSV-009** — Tab label for `PipeUtilizationHist.csv` is `PipeUtilizationHist` ([UI-55](../../../../docs/context/decisions/UI.md)).
