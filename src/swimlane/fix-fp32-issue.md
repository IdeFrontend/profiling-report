my 1st idea is the following: lets limit scale factor to scale where ULP will result to around 1/4 of device pixel
we can investiage this in real app usage and may be take it or (if not) use approach 2:
