...
- [`data/result.npu-rep`](data/result.npu-rep) — product 160-byte `npu-rep` sample (parsed in-browser via `parseNpuRep160`; partial — no `trace.json`)
...
- `data/sample.lite.rep` → `/data/sample.lite.rep`
