...
Maps product specs and interim decisions to stable **test ids**. See [docs/process/TESTING.md](../docs/process/TESTING.md) and [decisions/interim/](../docs/context/decisions/interim/).
